...
{
    public abstract class FFMpegCliArgs
    {
        ...
        protected FFMpegCliArgs(FFMpeg core)
        {
            Core = core;
        }
        ...
        /// <returns></returns>
        public FFMpegCliArgs NotifyOnProgress(Action<double> callback)
        {
        ...
        /// <returns></returns>
        public FFMpegCliArgs NotifyOnProgress(Action<TimeSpan> callback)
        {
        ...
        public FFMpegCliArgs SetLogPath(string path)
        {
            LogPath = path;
            return this;
        }

        public FFMpegCliArgs SetOverwrite(bool allow)
        {
            Overwrite = allow;
            return this;
        }
